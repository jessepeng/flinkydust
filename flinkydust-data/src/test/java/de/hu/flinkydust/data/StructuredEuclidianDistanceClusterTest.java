...
public class StructuredEuclidianDistanceClusterTest {
    ...
    public void testMerge() {
        ...
        Cluster<EuclidianDistanceMeasurableDataPoint> cluster1 = new StructuredEuclidianDistanceCluster(dataPoint1);
        Cluster<EuclidianDistanceMeasurableDataPoint> cluster2 = new StructuredEuclidianDistanceCluster(dataPoint2);
        Cluster<EuclidianDistanceMeasurableDataPoint> cluster3 = new StructuredEuclidianDistanceCluster(dataPoint3);

        Cluster<EuclidianDistanceMeasurableDataPoint> resultingCluster = cluster1.merge(cluster2);
        resultingCluster = resultingCluster.merge(cluster3);

        EuclidianDistanceMeasurableDataPoint centroid = resultingCluster.getCentroid();
