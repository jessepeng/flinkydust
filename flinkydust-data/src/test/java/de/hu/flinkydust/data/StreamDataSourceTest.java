...
public class StreamDataSourceTest {
    ...
    public void testMinAggregation() throws Exception {
        ...
        Assert.assertThat(minList.get(0).getLarge(), Is.is(-161480.0));
    ...
    public void testMaxAggregation() throws Exception {
        ...
        Assert.assertThat(minList.size(), Is.is(1));
        Assert.assertThat(minList.get(0).getSmall(), Is.is(1537877.0));
    ...
    public void testProjection() throws Exception {
        ...
        Assert.assertThat(selectedList.get(0).getSmall(), Is.is(3680.0));
        Assert.assertThat(selectedList.get(0).getLarge(), Is.is(0.0));

        Assert.assertThat(selectedList2.get(0).getLarge(), Is.is(10.0));
        Assert.assertThat(selectedList2.get(0).getSmall(), Is.is(0.0));
    }
    ...
    public void testAvgAggregation() throws Exception {
        ...
        DataSource<DataPoint> dataSource = StreamDataSource.readFile("data/dust-2014.dat");
        long timeAfter = System.nanoTime();
        DataSource<DataPoint> avgSmall = dataSource.aggregation(new AvgAggregator("small"));
        ...
        Assert.assertThat(avgList.get(0).getSmall(), Is.is(27961.975451166792));
